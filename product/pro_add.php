...
<body>
  ...
  <h2 class="title staff-title">商品追加</h2>
  <form method="post" action="pro_add_check.php" class="form-group" enctype="multipart/form-data">
    <p>商品名を入力してください。</p>
    <input type="text" name="name" style="width:400px" class="form-control">
    <p>価格を入力してください。</p>
    <input type="text" name="price" style="width:150px" class="form-control">
    <p>画像を入力してください。</p>
    <input type="file" name="gazou" style="width:500px" class="form-control">
