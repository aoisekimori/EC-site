...
<body>
  ...
  　<?php
     try {
       ...
       $sql = 'UPDATE cafe_product SET name=?,price=?,gazou=? WHERE code=?';
   ...
   ?>
   <?php if($pro_gazou_name_old != $pro_gazou_name): ?>
     <?php if($pro_gazou_name_old!=''): ?>
      <?php unlink('./gazou/'.$pro_gazou_name_old); ?>
     <?php endif; ?>
   <?php endif; ?>
