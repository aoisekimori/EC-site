  ...
  <div class="header">
    ...
    <nav>
      <ul class="header-menu">
        ...
        <li><a href="staff_login_branch.php">スタッフの方はこちら</a></li>
      </ul>
    </nav>
  </div>
  <div class="staff-wrapper">
   <p class="alert alert-warning">ログアウトしました。</p>
   <a href="../staff_login/staff_login.php" class="btn btn-success">ログイン画面へ</a>
</div>
